...
public:
  ...
  EdgeType& GetReverseEdge( EdgeIdentifierType ) const;
  NodeType& GetSourceNode( EdgePointerType Edge ) const
    { return this->GetNode( Edge->SourceIdentifier ); }
  NodeType& GetSourceNode( EdgeType Edge ) const
    { return this->GetNode( Edge.SourceIdentifier ); }
  NodeType& GetSourceNode( EdgeIdentifierType Id ) const
    { return this->GetSourceNode( this->GetEdgePointer( Id ) ); }
  NodeType& GetTargetNode( EdgePointerType Edge ) const
    { return this->GetNode( Edge->TargetIdentifier ); }
  NodeType& GetTargetNode( EdgeType Edge ) const
    { return this->GetNode( Edge.TargetIdentifier ); }
  NodeType& GetTargetNode( EdgeIdentifierType Id ) const
    { return this->GetTargetNode( this->GetEdgePointer( Id ) ); }
  EdgeType& GetEdge( NodeIdentifierType, NodeIdentifierType ) const;

  NodePointerType GetNodePointer( NodeIdentifierType Id ) const
    { return &m_Nodes->ElementAt( Id ); }
  EdgePointerType GetEdgePointer( EdgeIdentifierType Id ) const
    { return &m_Edges->ElementAt( Id ); }
  EdgePointerType GetReverseEdgePointer( EdgeIdentifierType ) const;
  EdgePointerType GetReverseEdgePointer( EdgePointerType ) const;
  NodePointerType GetSourceNodePointer( EdgePointerType Edge ) const
    { return this->GetNodePointer( Edge->SourceIdentifier ); }
  NodePointerType GetSourceNodePointer( EdgeIdentifierType Id ) const
    { return this->GetSourceNodePointer( this->GetEdgePointer( Id ) ); }
  NodePointerType GetTargetNodePointer( EdgePointerType Edge ) const
    { return this->GetNodePointer( Edge->TargetIdentifier ); }
  NodePointerType GetTargetNodePointer( EdgeIdentifierType Id ) const
    { return this->GetTargetNodePointer( this->GetEdgePointer( Id ) ); }
  EdgePointerType GetEdgePointer( NodeIdentifierType, NodeIdentifierType ) const;
  EdgePointerType GetEdgePointer( NodePointerType, NodePointerType ) const;
